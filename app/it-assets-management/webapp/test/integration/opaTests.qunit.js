...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "it/assets/management/itassetsmanagement/test/integration/FirstJourney",
    "it/assets/management/itassetsmanagement/test/integration/AssetsListJourney",
    "it/assets/management/itassetsmanagement/test/integration/AssetsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
